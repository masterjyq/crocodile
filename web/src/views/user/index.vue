  ...
  <div class="app-container">
    ...
    >
      ...
      <div style="margin-left: 120px">
        <el-button size="small" type="primary" @click="submituser('user')"
          >确 定</el-button
        >
        <el-button
          size="small"
    ...
    <div v-else>
      <div style="float: right">
        <el-tooltip
          ...
          placement="top-start"
        >
          <el-button type="primary" size="small" @click="createuserpre"
            >New</el-button
          >
        </el-tooltip>
      </div>
      ...
      >
        ...
        <el-table-column align="center" label="用户类型" min-width="70">
          <template slot-scope="scope">
            ...
            <el-tag v-if="scope.row.role === 2" type="danger" size="mini">{{
              scope.row.rolestr
            }}</el-tag>
            <el-tag v-if="scope.row.role === 3" type="info" size="mini">{{
              scope.row.rolestr
            }}</el-tag>
          </template>
        </el-table-column>
